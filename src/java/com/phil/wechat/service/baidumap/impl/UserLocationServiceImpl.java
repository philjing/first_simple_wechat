package com.phil.wechat.service.baidumap.impl;
...
public class UserLocationServiceImpl implements UserLocationService {
	...
	public List<BaiduPlace> searchPlace(String query, String lng, String lat) throws Exception{
        ...
        // 调用Place API圆形区域检索  
        String respXml = HttpRequestUtil.httpRequest(requestUrl, null, null, null);  
        // 解析返回的xml
	...
	public UserLocation convertCoord(String lng, String lat) {
        ...
        try {  
            String jsonCoord = HttpRequestUtil.httpRequest(convertUrl, null, null, null) ;
